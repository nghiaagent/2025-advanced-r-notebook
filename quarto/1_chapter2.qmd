...
Because they by default creates syntactic names from headers. This changes data without user input.
...
Set `check.names = FALSE` for safety.
...
Because the remaining text following `.` can be intepreted as a scientific format number `123e1 = 1.23`
